...
|----|------|
| **状态** | 已完成 |
| **问题** | `docs/superpowers/plans/2026-07-21-ocr-hardening.md` 的执行记录写“已实施”，步骤 checkbox 仍为未勾选，易被当成未完成任务；另外两份现有 plan 已基本勾选。 |
...
| **涉及文件** | `docs/superpowers/plans/2026-07-21-ocr-hardening.md`、本清单 |
